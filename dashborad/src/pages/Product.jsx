    ...
    <div className=' flex-1 overflow-auto relative z-10'>
      ...
      <main className='max-w-7xl mx-auto bg-gray-100 py-6 px-4 lg:px-8'>
        <div className='grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-8'
          ...
          <StatCard name="Total Sales" icon={Package} value='$12,34' color='#6366f1' />
          <StatCard name="New Users" icon={TrendingUp} value='$12,34' color='#8B5cf6' />
          <StatCard name="Total Product" icon={AlertTriangle} value='$12,34' color='#Ec4899' />
