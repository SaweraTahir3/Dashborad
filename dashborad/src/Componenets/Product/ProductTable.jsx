...
const productData = [
    ...
    { id: 2, name: "Iphone", category: "Mobile App", price: 39.99, stock: 89, sales: 19000 },
    { id: 3, name: "CoffeMaker", category: "support", price: 199.99, stock: 56, sales: 1400 },
    { id: 4, name: "NomanKhan", category: "clothing", price: 159.99, stock: 210, sales: 2200 },
    { id: 5, name: "NaseebaTahir", category: "outdoor", price: 79.99, stock: 73, sales: 8900 },
]
...
const ProductTable = () => {
    ...
    return (
        ...
        <div className='bg-purple-300 bg-opacity-50   border-purple-950 backdrop-blur-md px-10 py-5  shadow-lg rounded-xl border  '>
