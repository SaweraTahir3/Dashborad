...
//         <div className=' bg-gray-800   bg-opacity-25   backdrop-blur-md shadow-lg rounded-xl lg:col-span-2 p-6 z-1 border border-gray-900'>
//       h
//     </div>
//   )
// }
...
export default function App() {
  return (
      ...
      <div className=' bg-purple-50 bg-opacity-50 w-[200%]    backdrop-blur-md shadow-lg border-purple-900 rounded-xl  p-6 border 
